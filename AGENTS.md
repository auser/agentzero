...
- **Macros for repeated patterns**: Use `macro_rules!` (or derive macros) to eliminate repetitive patterns. Prefer macros over copy-pasting similar impl blocks across crates.
