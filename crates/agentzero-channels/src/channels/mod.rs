...
channel_catalog!(
    ...
    discord_history   => (DiscordHistoryChannel, DISCORD_HISTORY_DESCRIPTOR),
    ...
    gmail_push        => (GmailPushChannel, GMAIL_PUSH_DESCRIPTOR),
    ...
    voice_wake        => (VoiceWakeChannel, VOICE_WAKE_DESCRIPTOR),
