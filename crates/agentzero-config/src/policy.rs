...
pub fn load_tool_security_policy(
    ...
    let mut policy = ToolSecurityPolicy {
        ...
        web_search_config: WebSearchConfig {
            ...
            fallback_providers: config.web_search.fallback_providers.clone(),
            retries_per_provider: config.web_search.retries_per_provider,
            retry_backoff_ms: config.web_search.retry_backoff_ms,
        },
