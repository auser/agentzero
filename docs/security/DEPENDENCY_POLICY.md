...
- Grouped update PRs are preferred to reduce review churn while preserving security response speed.
...
- Dependency update PRs should include changelog/release-note impact when behavior changes are possible.
