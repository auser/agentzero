...
For most users, [MCP](/guides/mcp/) is the right choice. ACP exists for cases where you want AgentZero to own the full agentic loop — model selection, tool orchestration, and context management — rather than just exposing tools.
