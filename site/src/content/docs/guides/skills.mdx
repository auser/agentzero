...
The agent can generate new WASM tools at runtime via the `generate_tool` built-in tool. This is the self-improving agent capability described in [ADR 0012](/reference/adrs#adr-0012-self-improving-agent-via-wasm).
